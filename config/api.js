const FileOssUrl ="https://ms.jiqiao.tech/FileDown/DownFileOSSByType?guid="
const ImgUrl="https://ms.jiqiao.tech/FileDown/GetSharedImageQJZ?image_code="
const Url="https://testms.jiqiao.tech"
const QJZUrl="https://qjz.jiqiao.tech"
//const QJZUrl="http://localhost:5702"
//const Url="https://ms.jiqiao.tech"
...
module.exports={
    ...
    UserUrl:Url+"/AliMiniProgram/CheckAlipayCode",//验证用户是否存在记录    
    RegisterUrl:Url+"/AliMiniProgram/Register",//注册手机号
    VerificationCodeUrl:Url+"/AliMiniProgram/VerificationCode",//获取验证码
    QueryUserCustomerListUrl:Url+"/AliMiniProgram/QueryUserCustomerList",//查询绑定的客户信息列表
    ...
    DeletePreOrderUrl:Url+"/ProductAccount/DeletePreOrder",//删除未付款前置订单
    WxPayOrderPrepaidUrl: Url + '/PayAPIJQ/OrderPrepaidMiniP', //微信支付
    PostOrderAffirmPay: Url + '/ProductAccount/PostOrderAffirmPay', //账户支付
    AlipayTradeCreate:Url+"/AliMiniProgram/AlipayTradeCreate",//支付宝支付
    ...
    AlipayUserCertify: Url + '/AliMiniProgram/AlipayUserCertify', //支付宝身份验证
    AliPayVerifyCallBack: Url + '/AliMiniProgram/AliPayVerifyCallBack', //支付宝公司认证回调
